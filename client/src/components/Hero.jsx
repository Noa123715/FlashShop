...
const Hero = ({
  ...
  // 1. Keep these simple preventDefaults
  ...
  // 2. Update logic to actually grab the files from the drop event
  const handleDrop = (e) => {
    e.preventDefault();
  ...
  return (
    ...
    >
      ...
      <div className="relative container mx-auto px-6 text-center z-10">
        {/* 3. Moved event handlers to this visible DIV */}
        <div 
          className="border-2 border-dashed border-[#f2665e]/60 bg-white/80 backdrop-blur-md p-10 md:p-20 max-w-4xl mx-auto rounded-[30px] shadow-lg flex flex-col items-center justify-center min-h-[300px]"
